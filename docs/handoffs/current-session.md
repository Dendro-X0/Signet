...
**Updated:** 2026-08-03  
**Band:** **0.5.x** — v0.5.7 fault tolerance (Miro dogfood P0/P1)

## Next atomic step

Optional: **tag v0.5.7** + push + `release-cli` when ready to publish.
...
| Work | Owner |
|------|--------|
| Stale sums / freshness | `sign/checksum.rs`, `commands/verify.rs` |
| Post-sign sums log | `commands/build.rs` |
| Scan multi-target + platforms copy | `scan/report.rs` |
| Identity status alias | `commands/identity.rs` |
